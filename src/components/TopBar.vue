...
export default {
	data () {
		return {
			navs: [
				{name: '廉机商城', sourceUrl: 'http://www.mi.com/index.html'},
				{name: 'LJ', sourceUrl: 'http://www.miui.com/'},
				...
				{name: '廉机商城移动版', sourceUrl: 'http://www.mi.com/c/appdownload/'},
